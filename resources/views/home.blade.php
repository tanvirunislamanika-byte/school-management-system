        ...
        <div class="container">
            <div class="navbarWrapper">
                <div class="navLogoWrapper">
                    <div class="navLogo">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('assets/landing_page_images/Logo1.svg') }}"
                                class="logo" alt="">
                        </a>
                            ...
                            <div class="row wrapper">
                               ...
                               <div class="col-lg-6 infoBox">
                                    <div class="infoWrapper">
                                        ...
                                        <div>
                                            <span>{{ __('phone') }}</span>
                                            <span>{{ __('mobile') }} : {{ $settings['mobile'] ?? '+8801805464343' }}</span>
                                        </div>
                                    </div>
                                    <div class="infoWrapper">
                                        <div>
                                        ...
                                        <div>
                                            <span>{{ __('email') }}</span>
                                            <span>{{ $settings['mail_send_from'] ?? 'yessbangla.bd@gmail.com' }}</span>
                                        </div>
                                    </div>
                                    <div class="infoWrapper">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <span>{{ $settings['address'] ?? 'Block#A, Road#3, House#127 (Green View) (1st Floor), Mirpur#12, Dhaka#1216' }}</span>
                                        </div>
                                    </div>
                                    <div>
