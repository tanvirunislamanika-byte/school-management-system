                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="page-section mt-3">
                                ...
                                @else
                                <span class="text-danger">This feature is not included in your current pacakge</span>
                                @endif
                            </div>
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <div class="row mt-3">
                                            <div class="form-group col-sm-12 col-md-6">
                                                ...
                                                <input type="file" accept="image/*" name="counter_teacher"
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                ...
                                                <input type="file" accept="image/*" name="counter_student"
                                                    class="file-upload-default" />
                                                <div class="input-group col-xs-12">
                                                    <input type="text" class="form-control file-upload-info"
                                                        disabled="" placeholder="{{ __('image') }}" required />
                                            ...
                                            <div class="form-group col-sm-12 col-md-6">
                                                ...
                                                <input type="file" name="counter_stream" accept="image/*"
                                                    class="file-upload-default" />
                                                <div class="input-group col-xs-12">
                                                    <input type="text" class="form-control file-upload-info"
                                                        disabled="" placeholder="{{ __('image') }}" required />
                            ...
                            <div class="page-section mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <input type="file" name="our_mission_image" accept="image/*"
                                            class="file-upload-default" />
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info"
                                                disabled="" placeholder="{{ __('image') }}" required />
